...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addFavorities: function addFavorities(uuid) {
      var getFavorites = JSON.parse(JSON.stringify(this.favorities));
      console.log(getFavorites);
      getFavorites.push(uuid);
      this.favorities = getFavorites; // const parsed = JSON.stringify(this.favorities);
      // localStorage.setItem('favorities', parsed);

      console.log(getFavorites);
      console.log(_typeof(uuid));
    }
  }
});
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            "v-btn",
                            {
                              attrs: { fab: "", text: "", color: "primary" },
                              on: {
                                click: function($event) {
                                  return _vm.addFavorities(_vm.value.uuid)
                                }
                              }
                            },
                            [
