  ...
  methods: {
    getData: function getData() {
      ...
      axios.get(url).then(function (response) {
        _this.data[0].subtitle = response.data.views, _this.clicks = response.data.click_whatsapp, _this.favorites = response.data.favorites, console.log(_this.views);
