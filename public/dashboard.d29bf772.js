  ...
  methods: {
    getData: function getData() {
      ...
      axios.get(url).then(function (response) {
        _this.data[0].subtitle = response.data.views, _this.data[1].subtitle = response.data.click_whatsapp, _this.data[2].subtitle = response.data.favorites, console.log(_this.views);
