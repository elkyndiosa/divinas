...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    remove: function remove(item) {
      var index = this.servicesSelect.indexOf(item.name);
    ...
    getServices: function getServices() {
      ...
      axios.get(url).then(function (response) {
        _this5.services = JSON.parse(JSON.stringify(response.data));
        console.log(_this5.services);
      })["catch"](function (error) {
        console.log(error);
      });
    },
                                  ...
                                  _vm._b(
                                    {
                                      ...
                                      on: {
                                        ...
                                        "click:close": function($event) {
                                          return _vm.remove(data.item.name)
                                        }
                                      }
                                    },
                                    "v-chip",
