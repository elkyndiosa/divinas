...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    removeFavoritiesFavorities: function removeFavoritiesFavorities(uuid) {
                          ...
                          _c(
                            "v-btn",
                            {
                              attrs: {
                                fab: "",
                                text: "",
                                color: _vm.isFavorite(_vm.value.uuid)
                                  ? "primary"
                                  : "white"
                              },
                              on: {
                                click: function($event) {
                                  !_vm.isFavorite(_vm.value.uuid)
