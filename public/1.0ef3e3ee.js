...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    isFavorite: function isFavorite() {
      // var favorties = localStorage.favorities;
      // for (let index = 0; index < favorties.length; index++) {
      //   if(favorties[index] == this.value.uuid){
      //     console.log(favorties[index], 'true')
      return false; //   }else{
      //     console.log(favorties[index], 'false')
      //      return false
      //   }
      // }
    }
  ...
  methods: {
    ...
    removeFavorities: function removeFavorities(uuid) {
      ...
      var favorities = this.$store.state.favorities; // var fruits = ["Banana", "Orange", "Apple", "Mango"];
    ...
    created: function created() {
      console.log('idesxjkjhjh');
      var favorties = JSON.parse(localStorage.favorities);

      for (var index = 0; index < favorties.length; index++) {
        // if(favorties[index] == this.value.uuid){
        // "ace6fae4-4df6-459d-a936-40dfd31132ed"
        console.log(favorties[index], 'idesxjkjhjh'); //  return true
        //   }else{
        //     console.log(favorties[index], 'false')
        //      return false
        //   }
            ...
            [
              _c(
                "v-img",
                {
                  attrs: {
                    src:
                      "/uploads/images/" + JSON.parse(_vm.value.imgages_path),
                    height: "100%",
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "v-col",
                        {
                          staticClass: "pa-0 d-flex justify-content-end",
                          attrs: { cols: "12" }
                        },
                        [
                          _c("v-spacer"),
                          ...
                          _c(
                            "v-btn",
                            {
                              attrs: {
                                fab: "",
                                text: "",
                                color: _vm.isFavorite ? "primary" : "white"
                              },
                              on: {
                                click: function($event) {
                                  !_vm.isFavorite
                                    ? _vm.addFavorities(_vm.value.uuid)
                                    : _vm.removeFavorities(_vm.value.uuid)
                                }
                              }
                            },
                            [
